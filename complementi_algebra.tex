...
Il gruppo derivato $G'$ "misura quanto è abeliano" $G$, nel senso specificato 
...
\begin{remark}
    ...
    $\Hom(G, A)$ e $\Hom(\faktor{G}{G'}, A)$. Consideriamo infatti $\varphi \in \Hom(G, A)$,
    ...
    \begin{center}
        \begin{tikzcd}[column sep = small, row sep = small]
            ...
            {}\arrow[rr, "\circlearrowright", phantom]& & {}& \\
            & & & \\
