...
\begin{proof}
    ...
    supporre che $\mathcal{R} = \langle r\rangle$, cioè $\ord(r) = n$. 
...
\begin{itemize}
    \item[(1)]$\varphi(s) = sr^h$, con $0\leqslant h < n$;
    \item[(2)]$\varphi(s) = r^{\frac n 2}$, se $n$ è pari.
\end{itemize}
...
È quindi utile riuscire a determinare se i sottogruppi $H\times\{e_K\}$, $\{e_H\}\times K$
