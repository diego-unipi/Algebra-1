...
Diego Monaco, Niccolò Nannicini.
...
\begin{lemma}
    Dati $\sigma = \cycle{x_1, \ldots, x_k}\in S_n$ un $k$-ciclo e $\tau \in S_n$
    una trasposizione, allora 
    \[
        \tau\sigma\tau^{-1} = \cycle{\tau(x_1),\ldots, \tau(x_n)}
    \]
\end{lemma}

\begin{proof}
    Se $\sigma$ e $\tau$ sono cicli disgiunti allora abbiamo che
    $\sigma$ e $\tau$ commutano e che $\tau$ fissa
    gli elementi $x_1, \ldots, x_k$, pertanto 
    \[
        \cycle{\tau(x_1), \ldots, \tau(x_k)}=
        \cycle{x_1, \ldots, x_k} = \sigma = \sigma\tau^2 = \tau\sigma\tau^{-1}
    \]
    Sia allora $\tau = \cycle{x_a, x_b}$ con $a, b \in \{1, \ldots, k\}$ distinti,
    allora
    \[
