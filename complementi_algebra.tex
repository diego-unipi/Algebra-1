...
\begin{soln}
    ...
    \hyperref[lemma3.0]{Lemma 7.2} abbiamo $|G_i| = |\Omega_i|$ per ogni 
    ...
    \]pertanto per il \hyperref[lemma4.0]{Lemma 7.3} abbiamo $|G| \leq 3^m$, 
    ...
    Sempre per il \hyperref[lemma4.0]{Lemma 7.3} allora $k = m$ e $|\Omega_i| = 3$
...
\begin{remark}
    ...
    \[
        3m + 2 = \sum_{i = 1}^k a_i
    \]
    ragionando come nella dimostrazione del \hyperref[lemma4.0]{Lemma 7.3}
    possiamo scrivere
    \[
...
\begin{remark}
    ...
    prodotto sono tra loro coniugate. Infatti, per il \hyperref[lemma5.0]{Lemma 7.4}
    abbiamo 
    \[
...
\subsection{Generatori di $S_n$ e $\mathcal{A}_n$}
...
\begin{remark}
    ...
    quoziente di $D_4$, in effetti è proprio isomorfo a $D_4$, e quindi 
    non genera $S_4$. 
\end{remark}
