...
$\langle r^k, sr^h\rangle$. Consideriamo gli automorfismi di coniugio \[
    \varphi_s: D_n \longrightarrow D_n :x \longmapsto sxs^{-1}\]
\[
...
$h \equiv h - 2 \mod k$, cioè $k \in \{1, 2\}$.\begin{itemize}
    ...
    \item se $k = 2$ allora $H_{k, h} = \langle r^2, sr\rangle$ oppure 
...
\begin{remark}
    ...
    metà sui lati e metà lungo le diagonali. In un poligono con un numero dispari
