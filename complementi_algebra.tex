...
\begin{proof}
    ...
    Consideriamo $H, K\leqslant D_n$ due sottogruppi, distinguiamo tre casi 
    \begin{itemize}
        ...
        con $m \mid n$ e $0\leqslant l < m$, considerando le intersezioni con $\mathcal{R}$ 
