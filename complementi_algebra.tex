...
\begin{proof}
    ...
    \begin{itemize}
        ...
        \hyperref[prop2.0]{Proposizione 1.49} vale $[N:K] \in \{1, 2\}$, 
...
ma questo è assurdo in quanto per la \hyperref[prop1.0]{Proposizione 1.41} 
...
abbiamo visto nella dimostrazione della \hyperref[prop5.0]{Proposizione 1.67}
