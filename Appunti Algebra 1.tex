...
\begin{proof}
    ...
    \begin{enumerate}[(1)]
        ...
        \item Per il (2) della \hyperref[2.26]{Proposizione 2.26} $\faktor{A}{I}$ è un campo se e solo se gli unici ideali che contiene sono quelli impropri, $\ol{(0)}$ e $\faktor{A}{I}$, dunque per il 
        ...
        $\pi_I^{-1}\left(\faktor{A}{I}\right) = A$ e $\pi_I^{-1}(\ol{(0)}) = I$.}, ovvero $I$ è un ideale massimale di $A$.
    \end{enumerate}
\end{proof}
...
\begin{proof}
    ...
    è equivalente al fatto che $\faktor{A}{J}$ sia un dominio (campo), e, ugualmente deve essere che $\frac{A/I}{J/I}$ è un dominio (campo) ma dal Secondo Teorema di Omomorfismo di Anelli si ha:
...
\begin{remark}
    [$S = A \setminus\{0\}$]
    Se $A$ è un dominio, allora $S = A \setminus\{0\}$ è una parte moltiplicativa, infatti, $\forall x,y \in S$, ovvero $x \ne 0$ e $y \ne 0$, dunque 
    $xy \in S$, $xy \ne 0$.
\end{remark}
...
\begin{proof}
    ...
    \begin{itemize}
        \item Per verificare che $Q(A)$ sia un campo, ci basta verificare che esistono gli inversi moltiplicativi, e ciò segue immediatamente
         dal fatto che $\forall a \in A$, $a \ne 0$, allora $\displaystyle\frac{1}{a} \in Q(A)$ ed è tale per cui:
...
\begin{example}[Localizzato di un ideale primo]
    ...
    \[ \ZZ_{(2)} = \left\{\frac{a}{b} \m a \in \ZZ, (b,2) = 1\right\}
        \]
\end{example}
...
\begin{remark}
    ...
    \[ S^{-1}I = \left\{\frac{x}{s} \in S^{-1}A \m x \in I, s \in S \right\} \cong \frac{I \times S}{\sim}
        \]
    per tale insieme valgono le proprietà espresse dalla proposizione successiva.
\end{remark}
...
\begin{proposition}
    ...
    \begin{enumerate}[(1)]
        ...
        \item Sia $P$ un ideale primo di $A$, con $P \cap S = \emptyset$, allora $S^{-1}P$ (la localizzazione di $P$ ad $S$) è un ideale primo di $S^{-1}A$.
    \end{enumerate}
\end{proposition}
...
\begin{proof}
    ...
    \begin{enumerate}[(1)]
        ...
        \item Sia $P$ un ideale primo, se fosse $P \cap S = \emptyset$, allora per quanto visto al punto (3) non è proprio (e dunque nemmeno primo), viceversa, se $P \cap S = \emptyset$ vogliamo dimostrare che $S^{-1}P$ primo in $S^{-1}A$, consideriamo:
...
\begin{proposition}
    Dati due elementi $a,b \in A$, $d$ e $d^{\prime}$ sono due massimi comun divisori di $a$ e $b$, $d=(a,b)$ e $d^{\prime} = (a,b)$, se e solo se sono associati, $d \sim d^{\prime}$.
\end{proposition}
...
\begin{remark}
    ...
    \begin{itemize}
        ...
        Infatti, sicuramente è vero che $(a,b) \subset (d)$, ma non è detto che valga il contenimento opposto, il quale vale solo se $d = ax_0 + by_0$. Ad esempio, preso l'UFD $\Z[x]$, l'ideale:
        \[ I = (2,x)
            \]
...
\begin{proof}
    Iniziamo quindi verificando i primi due punti come segue.
    \begin{enumerate}[(1)]
