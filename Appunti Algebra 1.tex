...
\begin{remark}
    Poiché $L^H$ non è detto che $\sigma(L^H)$ faccia $L^H$, sarà tuttavia sempre una sottoestensione di $\faktor{L}{K}$, poiché $L$ è ancora fissato,
...
\begin{theorem}
    ...
    \[ \Gal\left(\faktor{L^H}{K}\right) \cong \frac{\Gal\left(\faktor{L}{K}\right)}{\Gal\left(\faktor{L}{L^H}\right)} \cong \faktor{G}{H}
        \]
\end{theorem}
...
\begin{remark}
    ...
    \end{tikzpicture}
        \]
    dove $G$ è il gruppo di Galois di $\faktor{L}{K}$. Essendo anche $\faktor{L^H}{L}$ di Galois 
...
Dati $H,K < \Gal\left(\faktor{L}{K}\right)$, allora valgono le seguenti:
\begin{enumerate}[(1)]
