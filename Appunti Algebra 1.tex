...
\begin{remark}
    ...
    \[ uv = 1\footnote{Stiamo usando il fatto che nei complessi il prodotto fa 1 se è tra elementi coniugati.} \implies v = \ol u \implies u\ol u = 1
        \]
    ovvero $u = \varepsilon + i\delta \in \ZZ[i]$ dove:
    \[ u \ol u = \varepsilon^2 + \delta^2 = 1
        \]
...
\]
e analogamente:
\[ x - iy = \ol u \,\ol\alpha^2 \qquad \ol\alpha \in \ZZ[i], \ol u \in \{\pm 1, \pm i\}
    \]
