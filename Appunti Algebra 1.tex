...
\begin{remark}
    ...
    \[ uv = 1 \implies 
       \footnote{Stiamo usando il fatto che nei complessi il prodotto fa 1 se è tra elementi coniugati.
       [Detto così è falso, infatti detto \alpha = \frac{1}{\sqrt{2}} si ha che \alpha non è coniugato a sé stesso ma \alpha\alpha = \frac{1}{2} + \frac{1}{2} = 1]
       } \quad 
