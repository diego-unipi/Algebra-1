...
Sia $\mathscr{C} = \{I_\lambda | \lambda \in \Lambda\}$ una catena in $\mathcal{F}$, si osserva che $I = \bigcup_{\lambda \in \Lambda}I_\lambda$ è un maggiorante per $\mathcal{C}$ ed è un ideale di $A$ (gli ideali si 
