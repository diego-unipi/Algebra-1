...
\begin{remark}
    In generale, dato $G = \left\{g_1 = e,g_2, \ldots, g_n\right\}$ e $\lambda : G \longrightarrow S(G) \cong S_n$, si ha che:
        \[ g_1 = e \longmapsto \varphi_{g_1} : G \longrightarrow G : g_i \longmapsto g_i
            \]
...
\begin{example}
    Nel caso in cui $G = \Z8$ e $X = S_3$, si ha l'azione:
        \[ \lambda : G \longrightarrow S(S_8) (\cong S_8) : \ol a \longmapsto \lambda_a
            \]
    che genera ad esempio le applicazioni:
            \begin{align*}
            \begin{array}{ccc}
            1 &\longmapsto \lambda_1 : S_8 \longrightarrow S_8 : a \longmapsto 1 + a \implies &(0,1,\ldots,7) \\
            2 &\longmapsto \lambda_2 : S_8 \longrightarrow S_8 : a \longmapsto 2 + a \implies &(0,2,4,6)(1,3,5,7)\\
            4 &\longmapsto \lambda_4 : S_8 \longrightarrow S_8 : a \longmapsto 4 + a \implies &(0,4)(1,5)(2,6)(3,7)\\		
            \end{array}
            \end{align*}
