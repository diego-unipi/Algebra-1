...
\begin{proof}
    ...
    Poiché $\mu_\alpha(x)$ è irriducibile per definizione, allora $\varphi(\mu_\alpha(x))$ è irriducibile, inoltre, $\deg \mu_\alpha(x) = \varphi(\mu_\alpha(x))$ (poiché l'omomorfismo è
