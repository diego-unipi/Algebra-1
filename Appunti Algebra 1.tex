...
\begin{proof}
    ...
    dunque, determinato un omomorfismo da $K[x]$ ad $\overline K$ possiamo applicare il \hyperref[omo]{Primo Teorema di Omomorfismo}. 
    Consideriamo l'omomorfismo di valutazione in un generico elemento $\overline K$:
    \[ \widetilde{\varphi}_{\beta} : K[x] \longrightarrow \overline K : x \longmapsto \beta , p(x) \longmapsto p(\beta) \qquad \beta \in \overline K
        \]
